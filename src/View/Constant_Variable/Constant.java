...
public class Constant {
    ...
    public static final String ENTER_BIRTH_DAY = "Nhập ngày sinh yyyy-MM-dd";
    public static final String ENTER_1_OR_2 = "Nhập 1 nếu muốn thêm dược sĩ, nhập 2 nếu muốn thêm quản lý";
    public static final String ONE = "1";
    public static final String ENTER_CODE_STAFF = "Nhập mã nhân viên";
    public static final String ENTER_GROUP_OF_STAFF = "Nhập team nhân viên";
    public static final String ENTER_AREA_WORK = "Nhập địa bàn làm việc của trình dược";
    public static final String TWO = "2";
    public static final String ENTER_LEVEL = "Nhập chức vụ";
    public static final String ENTER_MAJOR = "Nhập bằng cấp [Đại học, Cao đẳng]";
    public static final String ENTER_OBJECT = "1. Thêm đối tượng";
    public static final String SHOW_ALL = "2. Hiển thị toàn bộ danh sách đối tượng";
